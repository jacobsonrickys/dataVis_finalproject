...
Adjusting the slider below changes the range. If we set the slider to it's maximum value, we see that all apartments in the data set are within 10 km from more than one public elementary school. This suggests that the government of Atlanta have done a good job at ensuring taht 
